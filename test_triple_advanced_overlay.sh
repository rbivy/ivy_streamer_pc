#!/bin/bash
# Advanced triple stream test with detailed telemetry overlays

PI_IP="192.168.1.202"

echo "========================================="
echo "  Advanced Triple Streams with Telemetry"
echo "========================================="
echo "Starting 3 video windows with detailed stats:"
...
echo ""
echo "All three receivers started with advanced overlays!"
...
cleanup() {
    ...
    kill $RGB_PID $LEFT_PID $RIGHT_PID $MONITOR_PID 2>/dev/null
